...
public class CustomGlobalFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        log.info("请求的路径：" + request.getPath());
        ...
        // TODO: 2023/01/02 通过accessKey在数据库查询到secretKey
...
//		}
        // TODO: 2023/01/02  校验nonce，此处只校验了位数
        ...
        // 5. 查询请求的模拟接口是否存在
        // TODO：通过远程调用backend接口去实现,从数据库中查询模拟接口是否存在，以及请求方法是否匹配（还可以校验请求参数）
        // 6. 请求接口，直接异步返回了
